...
public class ChiTietSanPham {
    ...
    public ChiTietSanPham(String id, String idSP, String idImei, String idMauSac, String idChipse, String idPin, String idPhanLoaiHang, String idRam, String idRom, String idManHinh, String idCamera, String idXuatXu, String idDongSP, Long giaNhap, Long giaBan, int namBH, String moTa, int soLuongTon, String trangThai, String anh) {
        this.id = id;
        this.idSP = idSP;
        this.idImei = idImei;
